...
použití propagace zvyšuje šanci na nalezení schématu, jemuž
stav odpovídá.}
...
% Podmínka, že pro každé \sigma existuje \sigma',
% zaručuje, že sort v \clauses' bude co nejvíce.
...
% tudíž tam přidává i opačné nerovnosti
% c_{\sort, v'} \not\approx c_{\sort, v}.
